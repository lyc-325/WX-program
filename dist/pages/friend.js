...
var Friend = function (_wepy$page) {
  (0, _inherits3.default)(Friend, _wepy$page);
  ...
  function Friend() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = Friend.__proto__ || (0, _getPrototypeOf2.default)(Friend)).call.apply(_ref, [this].concat(args))), _this), _this.config = {
